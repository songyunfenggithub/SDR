...
#pragma comment(lib,"../API/x64/sdrplay_api.lib")
...
int main(int argc, char* argv[])
{
	...
	else
	{
		...
		if (ndev > 0)
		{
			...
			bool loop = true;
			while (loop) // Small loop allowing user to control gain reduction in +/-1dB steps using keyboard keys
			{
				if (_kbhit())
				{
					c = _getch();
					...
					case 'd':
						...
						break;
					case 'i':
						printf_DevParams(deviceParams);
						printf_TunerParams(deviceParams);
						printf_ControlParams(deviceParams);
						break;
					case 'w':
						printf(
							"Ñ¡ÔñÉèÖÃ:\r\n"\
							"-- DevParams ------------------------------\r\n"\
							"0 scanf_DevParams_ppm\r\n"\
							"1 scanf_DevParams_fsFreq\r\n"\
							"2 scanf_DevParams_syncUpdate\r\n"\
							"3 scanf_DevParams_resetFlags)\r\n"\
							"-- TunerParams ----------------------------\r\n"\
							"4 scanf_TunerParams_bwType\r\n"\
							"5 scanf_TunerParams_ifType\r\n"\
							"6 scanf_TunerParams_loMode\r\n"\
							"7 scanf_TunerParams_gain\r\n"\
							"8 scanf_TunerParams_rfFreq\r\n"\
							"9 scanf_TunerParams_dcOffsetTuner\r\n"\
							"-- ControlParams --------------------------\r\n"\
							"10 scanf_ControlParams_dcOffset\r\n"\
							"11 scanf_ControlParams_decimation\r\n"\
							"12 scanf_ControlParams_agc\r\n"\
							"13 scanf_ControlParams_adsbMode\r\n"\
							"-------------------------------------------\r\n"
						);
						int fnum;
						scanf("%d",&fnum);
						setfuncs[fnum](chosenDevice, deviceParams);
						break;
					default:
						break;
					}
