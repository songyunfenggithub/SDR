...
cuda_CFilter3 clscudaMainFilter3Q;
...
__global__ void
cuda_core_Filter3_Demodulator(CFilter::FILTER_CORE_DATA_TYPE* filtted_result, FILTTED_DATA_TYPE* demodulator_result,
